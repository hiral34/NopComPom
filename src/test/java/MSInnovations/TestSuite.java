...
//            Assert.assertTrue(we.getText().contains("£"),"£ not found in"+we.getText());
        ...
        System.out.println("my name is raj");//only gets printed if softassert is passed if failed then errors out and
        // any steps after softassert are not carried out.
    }
    @Test
